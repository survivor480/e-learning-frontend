    ...
    <div className="gap-4 gap-y-12 rounded-[20px]">
      ...
      >
        <div className="rounded-full overflow-hidden m-2">
          <img width={120} height={120} src={UserIcon} alt="Learn Icon"></img>
        </div>
        <h1 className="text-[30px]">Test Title</h1>
        <p className="text-[15px] max-w-sm line-clamp-5">
          This is just a start of a very long paragraph just to test if it is
          going to work just like I want it to. Something of this sort is to be
          implemented. Gibberish starts from this to this. And Goes on and goes
          on and on. It continutes till the entire screen is clogged with
          content and tries to fit in as much as it can and still cannot be
